...
<div class="mb-3"><?= $this->Form->control('new_password', ['type' => 'password', 'label' => 'Nova senha (8 a 72 caracteres, até 72 bytes)', 'value' => '', 'required' => true, 'autocomplete' => 'new-password', 'class' => 'form-control']) ?></div>
