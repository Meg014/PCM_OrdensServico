...
<?php endforeach; ?>
<?php if ($user->isNew()): ?><div class="col-md-6"><?= $this->Form->control('password', ['label' => 'Senha inicial (8 a 72 caracteres)', 'type' => 'password', 'value' => '', 'autocomplete' => 'new-password', 'class' => 'form-control']) ?><small>Temporária para ADMIN/USUARIO; a conta TV não exige troca.</small></div><?php endif; ?>
