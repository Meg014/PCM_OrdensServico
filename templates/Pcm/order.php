...
<div class="row g-4">
<?php $blocks = [
    'Identificação e classificação' => ['Filial' => $snapshot->branch_code, 'Área Manut.' => $this->MaintenanceArea->name($snapshot->maintenance_area_code),
