...
?>
<div class="row g-3 pcm-maintenance-type-cards" aria-label="Classificações de serviço das O.S. em aberto">
    ...
    <div class="col-12 col-md-6">
        <a class="pcm-maintenance-type-card pcm-service-card text-decoration-none"
           href="<?= h($this->Url->build($cardRoute + ['?' => \App\Service\PcmIndicatorService::drilldownFilters($filters, $key), '#' => 'orders'])) ?>">
            <div><p><?= h(\App\Service\PcmServiceClassifier::LABELS[$classification]) ?></p><small>O.S. em aberto</small></div>
