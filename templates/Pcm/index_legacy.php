...
<header class="pcm-page-header">
    <p class="alert alert-secondary">Legado Excel — dados da última importação. Esta tela não representa a consulta atual ao Protheus.</p>
    <div>
