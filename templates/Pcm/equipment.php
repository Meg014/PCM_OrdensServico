...
<p class="text-body-secondary small">Exporta todos os resultados dos filtros aplicados em lotes, sem limite total arbitrário.</p>
...
<?php if (!$equipment['orders']): ?><tr><td colspan="7">Nenhuma O.S. encontrada para os filtros aplicados.</td></tr><?php endif; ?>
